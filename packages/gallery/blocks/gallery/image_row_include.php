	...
	<div class="backgroundRow" style="background: url('<?php   echo $imgInfo['thumbPath']?>') no-repeat left top; padding-left: 100px">
		...
		<table class="imgOptionsGrid" >
			<tr>
				...
				<td>
					<input type="text" name="caption[]" value="<?php  echo htmlentities($imgInfo['caption'], ENT_COMPAT, APP_CHARSET)?>" style="vertical-align: middle; font-size: 10px; width: 140px" />
			...
			<tr>
				...
				<td>
					<?php   $selectedCaptionFields=explode(',',$imgInfo['shownAttributes']) ?>
