<?php  
	...
	if (count($cArray) > 0) { ?>
<div class="ccm-page-list-two-col">
	<div class="row">
	<?php  
	for ($i = 0; $i < count($cArray); $i++ ) {
		$is_last = (1 == ($i % 2)); //results in TRUE for every 2nd item
		$cobj = $cArray[$i]; 
		...
		$thumb = $ih->getThumbnail($img, 490, 275, array('crop' => true, 'quality'=>90));
		$e = $i + 2;
		$title = $cobj->getCollectionName(); ?>

    	<div class="col_6 <?php  echo $is_last ? 'omega' : '';?>">
...
</div><!-- .ccm-page-list-two-col ends -->
<?php   } 
