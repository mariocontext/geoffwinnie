<?php  
	...
	if (count($cArray) > 0) { ?>
<div class="ccm-page-list-three-col">
	<div class="row">
	<?php  
	for ($i = 0; $i < count($cArray); $i++ ) {
		$is_last = (2 == ($i % 3)); //results in TRUE for every 3rd item
		$cobj = $cArray[$i]; 
		...
		$thumb = $ih->getThumbnail($img, 310, 200, array('crop' => true, 'quality'=>90));
		$e = $i + 3;
		$title = $cobj->getCollectionName(); ?>

    	<div class="col_4 <?php  echo $is_last ? 'omega' : '';?>">
